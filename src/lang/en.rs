...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("config_acc", "To let your technician control your Mac: click Configure below, then switch ON the ITStore Connect toggle in the window that opens."),
        ("config_screen", "To let your technician see your screen: click Configure below, then switch ON the ITStore Connect toggle in the window that opens."),
        ...
        ("config_input", "To allow keyboard and mouse control: click Configure below, then switch ON the ITStore Connect toggle in the window that opens."),
