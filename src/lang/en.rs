...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("config_acc", "ITStore Connect needs your permission so your technician can control the mouse and keyboard.\n\n1.  Click the blue \"Configure\" button below.\n2.  A Settings window will open.\n3.  Find \"ITStore Connect\" in the list and turn its switch ON.\n4.  If asked, click \"Quit & Reopen\".\n\nYou only need to do this once."),
        ("config_screen", "ITStore Connect needs your permission to show this screen to your technician.\n\n1.  Click the blue \"Configure\" button below.\n2.  A Settings window will open.\n3.  Find \"ITStore Connect\" in the list and turn its switch ON.\n4.  If asked, click \"Quit & Reopen\".\n\nYou only need to do this once."),
        ...
        ("config_input", "One last permission: allow ITStore Connect to use the keyboard and mouse.\n\n1.  Click the blue \"Configure\" button below.\n2.  A Settings window will open.\n3.  Find \"ITStore Connect\" in the list and turn its switch ON.\n4.  If asked, click \"Quit & Reopen\".\n\nYou only need to do this once."),
