...
pub static ref T: std::collections::HashMap<&'static str, &'static str> =
    [
        ...
        ("install_tip", "Please click the button below to install ITStoreConnect to the system."),
        ("config_acc", "ITStoreConnect needs Accessibility permission to control the mouse and keyboard during a remote session.\n\n1.  Click the blue \"Configure\" button below.\n2.  A Settings window will open.\n3.  Find \"ITStoreConnect\" in the list and turn its switch ON.\n4.  If asked, click \"Quit & Reopen\".\n\nYou only need to do this once."),
        ("config_screen", "ITStoreConnect needs Screen Recording permission to share this screen during a remote session.\n\n1.  Click the blue \"Configure\" button below.\n2.  A Settings window will open.\n3.  Find \"ITStoreConnect\" in the list and turn its switch ON.\n4.  When it asks, click \"Quit & Reopen\" — screen sharing only starts after the app restarts.\n\nYou only need to do this once."),
        ...
        ("doc_mac_permission", "https://itstore.co.il"),
        ...
        ("config_input", "ITStoreConnect needs Input Monitoring permission to use the keyboard and mouse during a remote session.\n\n1.  Click the blue \"Configure\" button below.\n2.  A Settings window will open.\n3.  Find \"ITStoreConnect\" in the list and turn its switch ON.\n4.  When it asks, click \"Quit & Reopen\" — the keyboard only works after the app restarts.\n\nYou only need to do this once."),
